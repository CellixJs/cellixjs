...
To add a new portal (e.g., `ui-support`), copy this file to `apps/docs/docs/portals/ui-support/addition-evidence.md` and update all `UI_STAFF` → `UI_SUPPORT` references and the variable group name.
