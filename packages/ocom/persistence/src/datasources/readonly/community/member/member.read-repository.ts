...
export interface MemberReadRepository {
    getByCommunityId: (communityId: string, options?: FindOptions) => Promise<Domain.Member.MemberEntityReference[]>;
    getById: (id: string, options?: FindOneOptions) => Promise<Domain.Member.MemberEntityReference | null>;
    getByIdWithRole: (id: string, options?: FindOneOptions) => Promise<Domain.Member.MemberEntityReference | null>;
     /**
     ...
     */
    getMembersForEndUserExternalId: (externalId: string) => Promise<Domain.Member.MemberEntityReference[]>;
...
export class MemberReadRepositoryImpl implements MemberReadRepository {
     ...
     */
    async getByCommunityId(communityId: string, options?: FindOptions): Promise<Domain.Member.MemberEntityReference[]> {
     ...
     */
    async getById(id: string, options?: FindOneOptions): Promise<Domain.Member.MemberEntityReference | null> {
     ...
     * @returns A promise that resolves to a MemberEntityReference object or null if not found.
     */
    async getByIdWithRole(id: string, options?: FindOneOptions): Promise<Domain.Member.MemberEntityReference | null> {
    ...
    async getMembersForEndUserExternalId(externalId: string): Promise<Domain.Member.MemberEntityReference[]> {
