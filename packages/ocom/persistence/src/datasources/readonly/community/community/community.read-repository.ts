...
export interface CommunityReadRepository {
    getAll: (options?: FindOptions) => Promise<Domain.Community.CommunityEntityReference[]>;
    getById: (id: string, options?: FindOneOptions) => Promise<Domain.Community.CommunityEntityReference | null>;
    getByIdWithCreatedBy: (id: string, options?: FindOneOptions) => Promise<Domain.Community.CommunityEntityReference | null>;
    getByEndUserExternalId: (endUserId: string) => Promise<Domain.Community.CommunityEntityReference[]>;
}
...
export class CommunityReadRepositoryImpl implements CommunityReadRepository {
     ...
     */
    async getAll(options?: FindOptions): Promise<Domain.Community.CommunityEntityReference[]> {
     ...
     */
    async getById(id: string, options?: FindOneOptions): Promise<Domain.Community.CommunityEntityReference | null> {
     ...
     * @returns A promise that resolves to a CommunityEntityReference object or null if not found.
     */
    async getByIdWithCreatedBy(id: string, options?: FindOneOptions): Promise<Domain.Community.CommunityEntityReference | null> {
     ...
     */
    async getByEndUserExternalId(endUserId: string): Promise<Domain.Community.CommunityEntityReference[]> {
