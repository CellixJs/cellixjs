...
export interface CommunityReadRepository {
	...
	getByIdWithCreatedBy: (
		id: string,
		options?: FindOneOptions,
	) => Promise<Domain.Contexts.Community.Community.CommunityEntityReference | null>;
	getByEndUserExternalId: (
		endUserId: string,
	) => Promise<Domain.Contexts.Community.Community.CommunityEntityReference[]>;
}
...
export class CommunityReadRepositoryImpl implements CommunityReadRepository {
	...
	constructor(models: ModelsContext, passport: Domain.Passport) {
		this.mongoDataSource = new CommunityDataSourceImpl(
	...
	async getByEndUserExternalId(
		...
		return result.map((doc: Readonly<Community>) =>
