...
import {
	type EndUserDataSource,
	EndUserDataSourceImpl,
} from './end-user.data.ts';
...
test.for(feature, ({ Scenario, Background, BeforeEachScenario }) => {
	...
	Scenario(
		'Creating End User Read Repository Implementation',
		({ When, Then, And }) => {
			...
			And(
				'the EndUserReadRepo should be an EndUserReadRepository instance',
				() => {
