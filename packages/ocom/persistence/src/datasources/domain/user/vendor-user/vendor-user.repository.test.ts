...
const feature = await loadFeature(path.resolve(__dirname, 'features/vendor-user.repository.feature'));
...
test.for(feature, ({ Scenario, Background, BeforeEachScenario }) => {
	...
	BeforeEachScenario(() => {
		...
		repo = new VendorUserRepository(passport, ModelMock as unknown as VendorUserModelType, converter, eventBus, session);
	});
