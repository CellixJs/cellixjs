...
test.for(feature, ({ Scenario, Background, BeforeEachScenario }) => {
	...
	Scenario(
		'Getting and setting the firstName property',
		({ Given, When, Then }) => {
			Given('a StaffUserDomainAdapter for the document', () => {
				// Already set up
			});
	...
	Scenario(
		'Getting and setting the lastName property',
		({ Given, When, Then }) => {
			Given('a StaffUserDomainAdapter for the document', () => {
				// Already set up
			});
	...
	Scenario(
		...
		({ Given, When, Then }) => {
			...
			When(
				'I set the externalId property to "87654321-4321-4321-4321-210987654321"',
				() => {
					adapter.externalId = '87654321-4321-4321-4321-210987654321';
				},
			);
			Then(
				'the document\'s externalId should be "87654321-4321-4321-4321-210987654321"',
				() => {
	...
	Scenario('Getting role when populated', ({ Given, When, Then }) => {
		Given(
			'a StaffUserDomainAdapter for the document with populated role',
			() => {
	...
	Scenario('Getting role when role is ObjectId', ({ Given, When, Then }) => {
		Given(
			'a StaffUserDomainAdapter for the document with role as ObjectId',
			() => {
