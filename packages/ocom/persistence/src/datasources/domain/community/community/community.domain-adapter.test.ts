...
const domainAdapterFeature = await loadFeature(path.resolve(__dirname, 'features/community.domain-adapter.feature'));
const typeConverterFeature = await loadFeature(path.resolve(__dirname, 'features/community.type-converter.feature'));
