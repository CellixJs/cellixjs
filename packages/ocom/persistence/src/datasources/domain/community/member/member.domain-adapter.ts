...
export class MemberDomainAdapter
	extends MongooseSeedwork.MongooseDomainAdapter<Member>
	implements Domain.Contexts.Community.Member.MemberProps
{
	get memberName() {
	...
	get customViews(): PropArray<Domain.Contexts.Community.Member.MemberCustomViewEntityReference> {
		return new MongooseSeedwork.MongoosePropArray(
			this.doc.customViews,
			MemberCustomViewDomainAdapter,
		);
	}
}

export class MemberAccountDomainAdapter
	implements Domain.Contexts.Community.Member.MemberAccountProps
{
...
export class MemberCustomViewDomainAdapter
	implements Domain.Contexts.Community.Member.MemberCustomViewProps
{
...
export class MemberProfileDomainAdapter
	implements Domain.Contexts.Community.Member.MemberProfileProps
{
