...
const feature = await loadFeature(path.resolve(__dirname, 'features/member.repository.feature'));
...
test.for(feature, ({ Scenario, Background, BeforeEachScenario }) => {
	...
	BeforeEachScenario(() => {
		...
		repo = new MemberRepository(passport, ModelMock as unknown as MemberModelType, converter, eventBus, session);
	});
