...
test.for(
	...
	({ Scenario, Background, BeforeEachScenario }) => {
		...
		Scenario(
			'Getting and setting the roleName property',
			({ Given, When, Then }) => {
		...
		Scenario(
			'Getting and setting the isDefault property',
			({ Given, When, Then }) => {
				Given('an EndUserRoleDomainAdapter for the document', () => {
					adapter = new EndUserRoleDomainAdapter(doc);
				});
		...
		Scenario(
			...
			({ Given, When, Then }) => {
				...
				Given(
					'an EndUserRoleDomainAdapter for a document with community as an ObjectId',
					() => {
						doc = makeEndUserRoleDoc({
		...
		Scenario('Getting the permissions property', ({ Given, When, Then }) => {
			...
			Then(
				'it should return an EndUserRolePermissionsDomainAdapter instance',
				() => {
		...
		Scenario(
			'EndUserRolePermissionsDomainAdapter getting communityPermissions property',
			({ Given, When, Then }) => {
				let permissionsAdapter: EndUserRolePermissionsDomainAdapter;

				Given(
					'an EndUserRolePermissionsDomainAdapter for a permissions document',
					() => {
						permissionsAdapter = new EndUserRolePermissionsDomainAdapter(
							doc.permissions,
						);
					},
				);
				...
				Then(
					'it should return an EndUserRoleCommunityPermissionsDomainAdapter instance',
					() => {
		...
		Scenario(
			'EndUserRolePermissionsDomainAdapter getting propertyPermissions property',
			({ Given, When, Then }) => {
				let permissionsAdapter: EndUserRolePermissionsDomainAdapter;
				...
				Then(
					'it should return an EndUserRolePropertyPermissionsDomainAdapter instance',
					() => {
						expect(result).toBeInstanceOf(
							EndUserRolePropertyPermissionsDomainAdapter,
						);
		...
		Scenario(
			'EndUserRolePermissionsDomainAdapter getting serviceTicketPermissions property',
			({ Given, When, Then }) => {
				let permissionsAdapter: EndUserRolePermissionsDomainAdapter;
				...
				Then(
					'it should return an EndUserRoleServiceTicketPermissionsDomainAdapter instance',
					() => {
						expect(result).toBeInstanceOf(
							EndUserRoleServiceTicketPermissionsDomainAdapter,
						);
		...
		Scenario(
			'EndUserRolePermissionsDomainAdapter getting servicePermissions property',
			({ Given, When, Then }) => {
				let permissionsAdapter: EndUserRolePermissionsDomainAdapter;
				...
				Then(
					'it should return an EndUserRoleServicePermissionsDomainAdapter instance',
					() => {
						expect(result).toBeInstanceOf(
							EndUserRoleServicePermissionsDomainAdapter,
						);
		...
		Scenario(
			'EndUserRolePermissionsDomainAdapter getting violationTicketPermissions property',
			({ Given, When, Then }) => {
				let permissionsAdapter: EndUserRolePermissionsDomainAdapter;
				...
				Then(
					'it should return an EndUserRoleViolationTicketPermissionsDomainAdapter instance',
					() => {
						expect(result).toBeInstanceOf(
							EndUserRoleViolationTicketPermissionsDomainAdapter,
						);
		...
		Scenario(
			'EndUserRoleCommunityPermissionsDomainAdapter getting and setting canManageEndUserRolesAndPermissions property',
			({ Given, When, Then }) => {
				let communityPermissionsAdapter: EndUserRoleCommunityPermissionsDomainAdapter;

				Given(
					'an EndUserRoleCommunityPermissionsDomainAdapter for a community permissions document',
					() => {
						communityPermissionsAdapter =
							new EndUserRoleCommunityPermissionsDomainAdapter(
								doc.permissions.communityPermissions,
							);
					},
				);
				When('I get the canManageEndUserRolesAndPermissions property', () => {
					result =
						communityPermissionsAdapter.canManageEndUserRolesAndPermissions;
				});
				Then('it should return true', () => {
					expect(result).toBe(true);
				});
				When(
					'I set the canManageEndUserRolesAndPermissions property to false',
					() => {
						communityPermissionsAdapter.canManageEndUserRolesAndPermissions = false;
					},
				);
				Then(
					"the document's canManageRolesAndPermissions should be false",
					() => {
						expect(
							doc.permissions.communityPermissions.canManageRolesAndPermissions,
						).toBe(false);
					},
				);
			},
		...
		Scenario(
			'EndUserRoleCommunityPermissionsDomainAdapter getting and setting canManageCommunitySettings property',
			({ Given, When, Then }) => {
				let communityPermissionsAdapter: EndUserRoleCommunityPermissionsDomainAdapter;
				...
				Then(
					"the document's canManageCommunitySettings should be false",
					() => {
						expect(
							doc.permissions.communityPermissions.canManageCommunitySettings,
						).toBe(false);
					},
				);
			},
		...
		Scenario(
			'EndUserRoleCommunityPermissionsDomainAdapter getting and setting canManageSiteContent property',
			({ Given, When, Then }) => {
				let communityPermissionsAdapter: EndUserRoleCommunityPermissionsDomainAdapter;
				...
				Then("the document's canManageSiteContent should be false", () => {
					expect(
						doc.permissions.communityPermissions.canManageSiteContent,
					).toBe(false);
				});
			},
		);
		...
		Scenario(
			'EndUserRoleCommunityPermissionsDomainAdapter getting and setting canManageMembers property',
			({ Given, When, Then }) => {
				let communityPermissionsAdapter: EndUserRoleCommunityPermissionsDomainAdapter;
				...
				Then("the document's canManageMembers should be false", () => {
					expect(doc.permissions.communityPermissions.canManageMembers).toBe(
						false,
					);
				});
			},
		...
		Scenario(
			'EndUserRoleCommunityPermissionsDomainAdapter getting and setting canEditOwnMemberProfile property',
			({ Given, When, Then }) => {
				let communityPermissionsAdapter: EndUserRoleCommunityPermissionsDomainAdapter;
				...
				Then("the document's canEditOwnMemberProfile should be false", () => {
					expect(
						doc.permissions.communityPermissions.canEditOwnMemberProfile,
					).toBe(false);
				});
			},
		);
		...
		Scenario(
			'EndUserRoleCommunityPermissionsDomainAdapter getting and setting canEditOwnMemberAccounts property',
			({ Given, When, Then }) => {
				let communityPermissionsAdapter: EndUserRoleCommunityPermissionsDomainAdapter;
				...
				Then("the document's canEditOwnMemberAccounts should be false", () => {
					expect(
						doc.permissions.communityPermissions.canEditOwnMemberAccounts,
					).toBe(false);
				});
			},
		);
		...
		Scenario(
			'EndUserRolePropertyPermissionsDomainAdapter getting and setting canManageProperties property',
			({ Given, When, Then }) => {
				let propertyPermissionsAdapter: EndUserRolePropertyPermissionsDomainAdapter;

				Given(
					'an EndUserRolePropertyPermissionsDomainAdapter for a property permissions document',
					() => {
						propertyPermissionsAdapter =
							new EndUserRolePropertyPermissionsDomainAdapter(
								doc.permissions.propertyPermissions,
							);
					},
				);
				...
				Then("the document's canManageProperties should be false", () => {
					expect(doc.permissions.propertyPermissions.canManageProperties).toBe(
						false,
					);
				});
			},
		...
		Scenario(
			'EndUserRolePropertyPermissionsDomainAdapter getting and setting canEditOwnProperty property',
			({ Given, When, Then }) => {
				let propertyPermissionsAdapter: EndUserRolePropertyPermissionsDomainAdapter;
				...
				Then("the document's canEditOwnProperty should be false", () => {
					expect(doc.permissions.propertyPermissions.canEditOwnProperty).toBe(
						false,
					);
				});
			},
		...
		Scenario(
			'EndUserRoleServicePermissionsDomainAdapter getting and setting canManageServices property',
			({ Given, When, Then }) => {
				let servicePermissionsAdapter: EndUserRoleServicePermissionsDomainAdapter;

				Given(
					'an EndUserRoleServicePermissionsDomainAdapter for a service permissions document',
					() => {
						servicePermissionsAdapter =
							new EndUserRoleServicePermissionsDomainAdapter(
								doc.permissions.servicePermissions,
							);
					},
				);
				...
				Then("the document's canManageServices should be false", () => {
					expect(doc.permissions.servicePermissions.canManageServices).toBe(
						false,
					);
				});
			},
		...
		Scenario(
			'EndUserRoleServiceTicketPermissionsDomainAdapter getting and setting canCreateTickets property',
			({ Given, When, Then }) => {
				let serviceTicketPermissionsAdapter: EndUserRoleServiceTicketPermissionsDomainAdapter;

				Given(
					'an EndUserRoleServiceTicketPermissionsDomainAdapter for a service ticket permissions document',
					() => {
						serviceTicketPermissionsAdapter =
							new EndUserRoleServiceTicketPermissionsDomainAdapter(
								doc.permissions.serviceTicketPermissions,
							);
					},
				);
				...
				Then("the document's canCreateTickets should be false", () => {
					expect(
						doc.permissions.serviceTicketPermissions.canCreateTickets,
					).toBe(false);
				});
			},
		);
		...
		Scenario(
			'EndUserRoleServiceTicketPermissionsDomainAdapter getting and setting canManageTickets property',
			({ Given, When, Then }) => {
				let serviceTicketPermissionsAdapter: EndUserRoleServiceTicketPermissionsDomainAdapter;
				...
				Then("the document's canManageTickets should be false", () => {
					expect(
						doc.permissions.serviceTicketPermissions.canManageTickets,
					).toBe(false);
				});
			},
		);
		...
		Scenario(
			'EndUserRoleServiceTicketPermissionsDomainAdapter getting and setting canAssignTickets property',
			({ Given, When, Then }) => {
				let serviceTicketPermissionsAdapter: EndUserRoleServiceTicketPermissionsDomainAdapter;
				...
				Then("the document's canAssignTickets should be false", () => {
					expect(
						doc.permissions.serviceTicketPermissions.canAssignTickets,
					).toBe(false);
				});
			},
		);
		...
		Scenario(
			'EndUserRoleServiceTicketPermissionsDomainAdapter getting and setting canWorkOnTickets property',
			({ Given, When, Then }) => {
				let serviceTicketPermissionsAdapter: EndUserRoleServiceTicketPermissionsDomainAdapter;
				...
				Then("the document's canWorkOnTickets should be false", () => {
					expect(
						doc.permissions.serviceTicketPermissions.canWorkOnTickets,
					).toBe(false);
				});
			},
		);
		...
		Scenario(
			'EndUserRoleViolationTicketPermissionsDomainAdapter getting and setting canCreateTickets property',
			({ Given, When, Then }) => {
				let violationTicketPermissionsAdapter: EndUserRoleViolationTicketPermissionsDomainAdapter;

				Given(
					'an EndUserRoleViolationTicketPermissionsDomainAdapter for a violation ticket permissions document',
					() => {
						violationTicketPermissionsAdapter =
							new EndUserRoleViolationTicketPermissionsDomainAdapter(
								doc.permissions.violationTicketPermissions,
							);
					},
				);
				When('I get the canCreateTickets property', () => {
				...
				Then("the document's canCreateTickets should be false", () => {
					expect(
						doc.permissions.violationTicketPermissions.canCreateTickets,
					).toBe(false);
				});
			},
		);
		...
		Scenario(
			'EndUserRoleViolationTicketPermissionsDomainAdapter getting and setting canManageTickets property',
			({ Given, When, Then }) => {
				let violationTicketPermissionsAdapter: EndUserRoleViolationTicketPermissionsDomainAdapter;
				...
				Then("the document's canManageTickets should be false", () => {
					expect(
						doc.permissions.violationTicketPermissions.canManageTickets,
					).toBe(false);
				});
			},
		);
		...
		Scenario(
			'EndUserRoleViolationTicketPermissionsDomainAdapter getting and setting canAssignTickets property',
			({ Given, When, Then }) => {
				let violationTicketPermissionsAdapter: EndUserRoleViolationTicketPermissionsDomainAdapter;
				...
				Then("the document's canAssignTickets should be false", () => {
					expect(
						doc.permissions.violationTicketPermissions.canAssignTickets,
					).toBe(false);
				});
			},
		);
		...
		Scenario(
			'EndUserRoleViolationTicketPermissionsDomainAdapter getting and setting canWorkOnTickets property',
			({ Given, When, Then }) => {
				let violationTicketPermissionsAdapter: EndUserRoleViolationTicketPermissionsDomainAdapter;
				...
				Then("the document's canWorkOnTickets should be false", () => {
					expect(
						doc.permissions.violationTicketPermissions.canWorkOnTickets,
					).toBe(false);
				});
			},
		);
...
test.for(
	...
	({ Scenario, Background, BeforeEachScenario }) => {
		...
		Scenario(
			'Converting a Mongoose EndUserRole document to a domain object',
			({ Given, When, Then, And }) => {
				...
				Then('I should receive an EndUserRole domain object', () => {
					expect(result).toBeInstanceOf(
						Domain.Contexts.Community.Role.EndUserRole.EndUserRole,
					);
				});
				And('the domain object\'s roleName should be "Test Role"', () => {
					expect(
						(
							result as Domain.Contexts.Community.Role.EndUserRole.EndUserRole<EndUserRoleDomainAdapter>
						).roleName,
					).toBe('Test Role');
				});
				...
				And(
					"the domain object's community should be a Community domain object",
					() => {
						const { community } =
							result as Domain.Contexts.Community.Role.EndUserRole.EndUserRole<EndUserRoleDomainAdapter>;
						expect(community).toBeInstanceOf(
		...
		Scenario(
			'Converting a domain object to a Mongoose EndUserRole document',
			({ Given, And, When, Then }) => {
				...
				And(
					'an EndUserRole domain object with roleName "New Role", isDefault false, and valid community',
					() => {
						communityAdapter = new CommunityDomainAdapter(communityDoc);
						communityDomainObj =
							new Domain.Contexts.Community.Community.Community(
						...
						adapter.community = communityDomainObj;
						domainObj =
							new Domain.Contexts.Community.Role.EndUserRole.EndUserRole(
								adapter,
								passport,
							);
					},
				...
				And(
					"the document's community should be set to the correct community document",
					() => {
