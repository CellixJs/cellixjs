...
import { VendorUserRoleConverter, VendorUserRoleDomainAdapter, VendorUserRolePermissionsDomainAdapter } from './vendor-user-role.domain-adapter.ts';

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const domainAdapterFeature = await loadFeature(path.resolve(__dirname, 'features/vendor-user-role.domain-adapter.feature'));
const typeConverterFeature = await loadFeature(path.resolve(__dirname, 'features/vendor-user-role.type-converter.feature'));
