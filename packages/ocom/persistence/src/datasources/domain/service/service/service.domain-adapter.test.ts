...
import { ServiceConverter, ServiceDomainAdapter } from './service.domain-adapter.ts';
...
const domainAdapterFeature = await loadFeature(path.resolve(__dirname, 'features/service.domain-adapter.feature'));
const typeConverterFeature = await loadFeature(path.resolve(__dirname, 'features/service.type-converter.feature'));
