...
const feature = await loadFeature(path.resolve(__dirname, 'features/service-ticket-v1.repository.feature'));
...
test.for(feature, ({ Scenario, Background, BeforeEachScenario }) => {
	...
	BeforeEachScenario(() => {
		...
		repo = new ServiceTicketV1Repository(passport, ModelMock as unknown as ServiceTicketModelType, converter, eventBus, session);
	});
