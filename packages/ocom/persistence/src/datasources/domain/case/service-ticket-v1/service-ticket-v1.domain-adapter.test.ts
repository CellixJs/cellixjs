...
import { ServiceTicketV1Converter, ServiceTicketV1DomainAdapter, ServiceTicketV1ActivityDetailDomainAdapter, ServiceTicketV1MessageDomainAdapter } from './service-ticket-v1.domain-adapter.ts';
...
const feature = await loadFeature(path.resolve(__dirname, 'features/service-ticket-v1.domain-adapter.feature'));
const typeConverterFeature = await loadFeature(path.resolve(__dirname, 'features/service-ticket-v1.type-converter.feature'));
