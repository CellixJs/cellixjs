 ...
 * 
 * This file serves as the single entry point for all exports from the Case bounded context.
 * It consolidates exports from ServiceTicket and ViolationTicket aggregates (both V1),
 * along with their repositories, unit of work, and related types.
 */

//#region Exports

// ServiceTicket V1 aggregate, types, and contracts
export {
	ServiceTicketV1,
...
// ViolationTicket V1 aggregate, types, and contracts
export {
	ViolationTicketV1,
