...
const feature = await loadFeature(path.resolve(__dirname, 'features/service-ticket-v1-activity-detail.value-objects.feature'));
...
test.for(feature, ({ Scenario }) => {
	...
	// ActivityTypeCode
	Scenario('Creating an activity type code with valid value "CREATED"', ({ When, Then }) => {
		let value: string;
	...
	Scenario('Creating an activity type code with valid value "SUBMITTED"', ({ When, Then }) => {
		let value: string;
	...
	Scenario('Creating an activity type code with valid value "ASSIGNED"', ({ When, Then }) => {
		let value: string;
	...
	Scenario('Creating an activity type code with valid value "UPDATED"', ({ When, Then }) => {
		let value: string;
	...
	Scenario('Creating an activity type code with valid value "INPROGRESS"', ({ When, Then }) => {
		let value: string;
	...
	Scenario('Creating an activity type code with valid value "COMPLETED"', ({ When, Then }) => {
		let value: string;
	...
	Scenario('Creating an activity type code with valid value "CLOSED"', ({ When, Then }) => {
		let value: string;
