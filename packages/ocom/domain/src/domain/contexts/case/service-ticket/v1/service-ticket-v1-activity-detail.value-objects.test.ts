...
const feature = await loadFeature(
	path.resolve(
		__dirname,
		'features/service-ticket-v1-activity-detail.value-objects.feature',
	),
);
...
test.for(feature, ({ Scenario }) => {
	...
	// ActivityTypeCode
	Scenario(
		'Creating an activity type code with valid value "CREATED"',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating an activity type code with valid value "SUBMITTED"',
		({ When, Then }) => {
			let value: string;
			When('I create an activity type code with "SUBMITTED"', () => {
				value = new ValueObjects.ActivityTypeCode('SUBMITTED').valueOf();
			});
	...
	Scenario(
		'Creating an activity type code with valid value "ASSIGNED"',
		({ When, Then }) => {
			let value: string;
			When('I create an activity type code with "ASSIGNED"', () => {
				value = new ValueObjects.ActivityTypeCode('ASSIGNED').valueOf();
			});
	...
	Scenario(
		'Creating an activity type code with valid value "UPDATED"',
		({ When, Then }) => {
			let value: string;
			When('I create an activity type code with "UPDATED"', () => {
				value = new ValueObjects.ActivityTypeCode('UPDATED').valueOf();
			});
	...
	Scenario(
		'Creating an activity type code with valid value "INPROGRESS"',
		({ When, Then }) => {
			let value: string;
			When('I create an activity type code with "INPROGRESS"', () => {
				value = new ValueObjects.ActivityTypeCode('INPROGRESS').valueOf();
			});
	...
	Scenario(
		'Creating an activity type code with valid value "COMPLETED"',
		({ When, Then }) => {
			let value: string;
			When('I create an activity type code with "COMPLETED"', () => {
				value = new ValueObjects.ActivityTypeCode('COMPLETED').valueOf();
			});
	...
	Scenario(
		'Creating an activity type code with valid value "CLOSED"',
		({ When, Then }) => {
			let value: string;
			When('I create an activity type code with "CLOSED"', () => {
				value = new ValueObjects.ActivityTypeCode('CLOSED').valueOf();
			});
	...
	Scenario(
		'Creating an activity type code with invalid value',
		({ When, Then }) => {
			...
			Then(
				'an error should be thrown indicating the activity type code is invalid',
				() => {
					expect(createActivityTypeCodeWithInvalidValue).toThrow(
	...
	Scenario(
		'Creating an activity type code with undefined',
		({ When, Then }) => {
			...
			Then(
				'an error should be thrown indicating the activity type code is invalid',
				() => {
					expect(createActivityTypeCodeWithUndefined).toThrow(
