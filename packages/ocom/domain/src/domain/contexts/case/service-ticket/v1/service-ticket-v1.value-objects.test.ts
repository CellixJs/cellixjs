...
const feature = await loadFeature(path.resolve(__dirname, 'features/service-ticket-v1.value-objects.feature'));
...
test.for(feature, ({ Scenario }) => {
	...
	// StatusCode
	Scenario('Creating a status code with valid value "DRAFT"', ({ When, Then }) => {
		let value: string;
	...
	Scenario('Creating a status code with valid value "SUBMITTED"', ({ When, Then }) => {
		let value: string;
	...
	Scenario('Creating a status code with valid value "ASSIGNED"', ({ When, Then }) => {
		let value: string;
	...
	Scenario('Creating a status code with valid value "INPROGRESS"', ({ When, Then }) => {
		let value: string;
	...
	Scenario('Creating a status code with valid value "COMPLETED"', ({ When, Then }) => {
		let value: string;
	...
	Scenario('Creating a status code with valid value "CLOSED"', ({ When, Then }) => {
		let value: string;
