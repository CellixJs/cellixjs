...
export interface ViolationTicketV1UnitOfWork
	extends UnitOfWork<Passport, ViolationTicketV1Props, ViolationTicketV1<ViolationTicketV1Props>, ViolationTicketV1Repository<ViolationTicketV1Props>>,
		InitializedUnitOfWork<Passport, ViolationTicketV1Props, ViolationTicketV1<ViolationTicketV1Props>, ViolationTicketV1Repository<ViolationTicketV1Props>> {}
