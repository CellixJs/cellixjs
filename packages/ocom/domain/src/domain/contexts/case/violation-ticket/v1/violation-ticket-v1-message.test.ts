...
const feature = await loadFeature(path.resolve(__dirname, 'features/violation-ticket-v1-message.feature'));
...
test.for(feature, ({ Scenario, BeforeEachScenario }) => {
	...
	Scenario('Setting sent by with canManageTickets permission', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1Message instance', () => {
			message = new ViolationTicketV1Message(props, visa);
		});
	...
	Scenario('Setting sent by with isSystemAccount permission', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1Message instance', () => {
			message = new ViolationTicketV1Message(props, visa);
		});
	...
	Scenario('Setting sent by without sufficient permissions', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1Message instance', () => {
			message = new ViolationTicketV1Message(props, visa);
		});
	...
	Scenario('Setting message with canManageTickets permission', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1Message instance', () => {
			message = new ViolationTicketV1Message(props, visa);
		});
	...
	Scenario('Setting message with isSystemAccount permission', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1Message instance', () => {
			message = new ViolationTicketV1Message(props, visa);
		});
	...
	Scenario('Setting message without sufficient permissions', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1Message instance', () => {
			message = new ViolationTicketV1Message(props, visa);
		});
	...
	Scenario('Setting embedding with canManageTickets permission', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1Message instance', () => {
			message = new ViolationTicketV1Message(props, visa);
		});
	...
	Scenario('Setting embedding with isSystemAccount permission', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1Message instance', () => {
			message = new ViolationTicketV1Message(props, visa);
		});
	...
	Scenario('Setting embedding without sufficient permissions', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1Message instance', () => {
			message = new ViolationTicketV1Message(props, visa);
		});
	...
	Scenario('Setting isHiddenFromApplicant with canManageTickets permission', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1Message instance', () => {
			message = new ViolationTicketV1Message(props, visa);
		});
	...
	Scenario('Setting isHiddenFromApplicant with isSystemAccount permission', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1Message instance', () => {
			message = new ViolationTicketV1Message(props, visa);
		});
	...
	Scenario('Setting isHiddenFromApplicant without sufficient permissions', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1Message instance', () => {
			message = new ViolationTicketV1Message(props, visa);
		});
	...
	Scenario('Setting createdAt with isSystemAccount permission', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1Message instance', () => {
			message = new ViolationTicketV1Message(props, visa);
		});
	...
	Scenario('Setting createdAt without isSystemAccount permission', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1Message instance', () => {
			message = new ViolationTicketV1Message(props, visa);
		});
