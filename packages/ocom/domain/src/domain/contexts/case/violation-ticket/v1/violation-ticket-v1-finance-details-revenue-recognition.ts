...
export interface ViolationTicketV1FinanceDetailsRevenueRecognitionEntityReference
	extends Readonly<
		Omit<
...
export class ViolationTicketV1FinanceDetailsRevenueRecognition
	extends DomainSeedwork.ValueObject<ViolationTicketV1FinanceDetailsRevenueRecognitionProps>
