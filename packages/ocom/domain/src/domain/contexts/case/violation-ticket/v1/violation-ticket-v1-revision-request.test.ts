...
const feature = await loadFeature(path.resolve(__dirname, 'features/violation-ticket-v1-revision-request.feature'));
...
test.for(feature, ({ Scenario, BeforeEachScenario }) => {
	...
	Scenario('Creating a new ViolationTicketV1RevisionRequest using getNewInstance', ({ When, Then, And }) => {
		When('I create a new ViolationTicketV1RevisionRequest using getNewInstance', () => {
			...
			revisionRequest = ViolationTicketV1RevisionRequest.getNewInstance(newProps, memberRef, 'New summary', {
				requestUpdatedAssignment: false,
				requestUpdatedStatus: true,
				requestUpdatedProperty: false,
				requestUpdatedPaymentTransaction: true,
	...
	Scenario('Setting revision submitted at to undefined', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1RevisionRequest instance', () => {
			revisionRequest = new ViolationTicketV1RevisionRequest(props, visa);
		});
	...
	Scenario('Setting revision submitted at to a past date', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1RevisionRequest instance', () => {
			revisionRequest = new ViolationTicketV1RevisionRequest(props, visa);
		});
	...
	Scenario('Setting revision submitted at with canManageTickets permission', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1RevisionRequest instance', () => {
			revisionRequest = new ViolationTicketV1RevisionRequest(props, visa);
		});
	...
	Scenario('Setting revision submitted at with isSystemAccount permission', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1RevisionRequest instance', () => {
			revisionRequest = new ViolationTicketV1RevisionRequest(props, visa);
		});
	...
	Scenario('Loading requested by when the load function throws an error', ({ When, Then, And }) => {
		When('I have a ViolationTicketV1RevisionRequest instance', () => {
			revisionRequest = new ViolationTicketV1RevisionRequest(props, visa);
		});
	...
	Scenario('Creating with all requested changes false', ({ When, Then, And }) => {
	...
	Scenario('Creating with all requested changes true', ({ When, Then, And }) => {
