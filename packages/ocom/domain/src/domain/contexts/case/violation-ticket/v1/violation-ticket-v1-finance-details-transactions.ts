...
export interface ViolationTicketV1FinanceDetailsTransactionsEntityReference extends Readonly<Omit<ViolationTicketV1FinanceDetailsTransactionsProps, 'submission' | 'adhocTransactions'>> {
...
export class ViolationTicketV1FinanceDetailsTransactions extends ValueObject<ViolationTicketV1FinanceDetailsTransactionsProps> implements ViolationTicketV1FinanceDetailsTransactionsEntityReference {
