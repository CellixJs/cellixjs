...
import {
	...
	type ViolationTicketV1FinanceDetailsAdhocTransactionsEntityReference,
...
export interface ViolationTicketV1FinanceDetailsTransactionsProps
...
export interface ViolationTicketV1FinanceDetailsTransactionsEntityReference
	extends Readonly<
		Omit<
			ViolationTicketV1FinanceDetailsTransactionsProps,
			'submission' | 'adhocTransactions'
		>
	> {
...
export class ViolationTicketV1FinanceDetailsTransactions
	extends DomainSeedwork.ValueObject<ViolationTicketV1FinanceDetailsTransactionsProps>
	implements ViolationTicketV1FinanceDetailsTransactionsEntityReference
{
	private readonly visa: ViolationTicketV1Visa;
	constructor(
		props: ViolationTicketV1FinanceDetailsTransactionsProps,
