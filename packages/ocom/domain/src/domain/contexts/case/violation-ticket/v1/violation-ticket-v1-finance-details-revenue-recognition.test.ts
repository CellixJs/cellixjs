...
const feature = await loadFeature(
  path.resolve(__dirname, 'features/violation-ticket-v1-finance-details-revenue-recognition.feature'),
);
...
test.for(feature, ({ Scenario, BeforeEachScenario }) => {
  ...
  BeforeEachScenario(() => {
    submission = { id: 'submission-123' } as unknown as ViolationTicketV1FinanceDetailsGlTransactionEntityReference;
    recognition = { id: 'recognition-123' } as unknown as ViolationTicketV1FinanceDetailsGlTransactionEntityReference;
