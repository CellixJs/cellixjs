...
export interface ViolationTicketV1Repository<props extends ViolationTicketV1Props> extends Repository<ViolationTicketV1<props>> {
	getNewInstance(title: string, description: string, community: CommunityEntityReference, property: PropertyEntityReference, requestor: MemberEntityReference, penaltyAmount: number): Promise<ViolationTicketV1<props>>;
