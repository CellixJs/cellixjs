...
import { type ViolationTicketV1FinanceDetailProps, ViolationTicketV1FinanceDetails } from './violation-ticket-v1-finance-details.ts';
...
const feature = await loadFeature(path.resolve(__dirname, 'features/violation-ticket-v1-finance-details.feature'));
