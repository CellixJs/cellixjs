...
import { ViolationTicketV1Message, type ViolationTicketV1MessageEntityReference, type ViolationTicketV1MessageProps } from './violation-ticket-v1-message.ts';
...
import { ViolationTicketV1Photo, type ViolationTicketV1PhotoEntityReference, type ViolationTicketV1PhotoProps } from './violation-ticket-v1-photo.ts';
import { type ViolationTicketV1FinanceDetailProps, type ViolationTicketV1FinanceDetailEntityReference, ViolationTicketV1FinanceDetails } from './violation-ticket-v1-finance-details.ts';
import { type ViolationTicketV1RevisionRequestProps, type ViolationTicketV1RevisionRequestEntityReference, ViolationTicketV1RevisionRequest } from './violation-ticket-v1-revision-request.ts';
 ...
 */
export interface ViolationTicketV1EntityReference extends Readonly<
  Omit<ViolationTicketV1Props, 'activityLog' | 'messages' | 'photos' | 'financeDetails' | 'revisionRequest'>
> {
  ...
  readonly revisionRequest: ViolationTicketV1RevisionRequestEntityReference | undefined;
}
  ...
  implements ViolationTicketV1EntityReference
{
  ...
  private markAsNew(): void {
    this.isNew = true;
    this.addIntegrationEvent<ViolationTicketV1CreatedProps, ViolationTicketV1CreatedEvent>(ViolationTicketV1CreatedEvent, {
        id: this.props.id,
    });
  }
  ...
  public override onSave(isModified: boolean): void {
    if (isModified && !super.isDeleted) {
      this.addIntegrationEvent<ViolationTicketV1UpdatedProps, ViolationTicketV1UpdatedEvent>(ViolationTicketV1UpdatedEvent, { id: this.props.id });
    }
  }
  //#endregion Methods
  ...
  get activityLog(): ReadonlyArray<ViolationTicketV1ActivityDetailEntityReference> {
    return this.props.activityLog.items.map((item) => new ViolationTicketV1ActivityDetail(item, this.visa));
  }

  get messages(): ReadonlyArray<ViolationTicketV1MessageEntityReference> {
    return this.props.messages.items.map((item) => new ViolationTicketV1Message(item, this.visa));
  }

  get photos(): ReadonlyArray<ViolationTicketV1PhotoEntityReference> {
    return this.props.photos.items.map((item) => new ViolationTicketV1Photo(item, this.visa));
  }
  ...
  get revisionRequest(): ViolationTicketV1RevisionRequestEntityReference | undefined {
    return this.props.revisionRequest ? new ViolationTicketV1RevisionRequest(this.props.revisionRequest, this.visa) : undefined;
  }
...
//#region Exports
import { ViolationTicketV1, type ViolationTicketV1EntityReference, type ViolationTicketV1Props } from './violation-ticket-v1.aggregate.ts';
...
import type { ViolationTicketV1Visa } from './violation-ticket-v1.visa.ts';
import type { ViolationTicketV1ActivityDetailEntityReference, ViolationTicketV1ActivityDetailProps } from './violation-ticket-v1-activity-detail.ts';
import type { ViolationTicketV1MessageEntityReference, ViolationTicketV1MessageProps } from './violation-ticket-v1-message.ts';
import type { ViolationTicketV1PhotoEntityReference, ViolationTicketV1PhotoProps } from './violation-ticket-v1-photo.ts';
import type { ViolationTicketV1FinanceDetailEntityReference, ViolationTicketV1FinanceDetailProps } from './violation-ticket-v1-finance-details.ts';
import { ViolationTicketV1FinanceDetailsTransactions, type ViolationTicketV1FinanceDetailsTransactionsEntityReference, type ViolationTicketV1FinanceDetailsTransactionsProps } from './violation-ticket-v1-finance-details-transactions.ts';
import { ViolationTicketV1FinanceDetailsTransactionsSubmissionTransactionReference, type ViolationTicketV1FinanceDetailsTransactionsSubmissionTransactionReferenceEntityReference, type ViolationTicketV1FinanceDetailsTransactionsSubmissionTransactionReferenceProps } from './violation-ticket-v1-finance-details-transactions-submission-transaction-reference.ts';
import { ViolationTicketV1FinanceDetailsAdhocTransactionsTransactionReference, type ViolationTicketV1FinanceDetailsAdhocTransactionsTransactionReferenceEntityReference, type ViolationTicketV1FinanceDetailsAdhocTransactionsTransactionReferenceProps } from './violation-ticket-v1-finance-details-adhoc-transactions-transaction-reference.ts';
import { ViolationTicketV1FinanceDetailsTransactionsSubmission, type ViolationTicketV1FinanceDetailsTransactionsSubmissionEntityReference, type ViolationTicketV1FinanceDetailsTransactionsSubmissionProps } from './violation-ticket-v1-finance-details-transactions-submission.ts';
import type { ViolationTicketV1FinanceDetailsAdhocTransactionsEntityReference, ViolationTicketV1FinanceDetailsAdhocTransactionsProps } from './violation-ticket-v1-finance-details-adhoc-transactions.ts';
import { ViolationTicketV1FinanceDetailsAdhocTransactionsApproval, type ViolationTicketV1FinanceDetailsAdhocTransactionsApprovalEntityReference, type ViolationTicketV1FinanceDetailsAdhocTransactionsApprovalProps } from './violation-ticket-v1-finance-details-adhoc-transactions-approval.ts';
import { ViolationTicketV1FinanceDetailsAdhocTransactionsFinanceReference, type ViolationTicketV1FinanceDetailsAdhocTransactionsFinanceReferenceEntityReference, type ViolationTicketV1FinanceDetailsAdhocTransactionsFinanceReferenceProps } from './violation-ticket-v1-finance-details-adhoc-transactions-finance-reference.ts';
import { ViolationTicketV1FinanceDetailsRevenueRecognition, type ViolationTicketV1FinanceDetailsRevenueRecognitionEntityReference, type ViolationTicketV1FinanceDetailsRevenueRecognitionProps } from './violation-ticket-v1-finance-details-revenue-recognition.ts';
import { ViolationTicketV1FinanceDetailsGlTransaction, type ViolationTicketV1FinanceDetailsGlTransactionEntityReference, type ViolationTicketV1FinanceDetailsGlTransactionProps } from './violation-ticket-v1-finance-details-gl-transaction.ts';
import type { ViolationTicketV1RevisionRequestEntityReference, ViolationTicketV1RevisionRequestProps } from './violation-ticket-v1-revision-request.ts';

export { { ViolationTicketV1, type ViolationTicketV1EntityReference, type ViolationTicketV1Props }, { ViolationTicketV1FinanceDetailsTransactions, type ViolationTicketV1FinanceDetailsTransactionsEntityReference, type ViolationTicketV1FinanceDetailsTransactionsProps }, { ViolationTicketV1FinanceDetailsTransactionsSubmissionTransactionReference, type ViolationTicketV1FinanceDetailsTransactionsSubmissionTransactionReferenceEntityReference, type ViolationTicketV1FinanceDetailsTransactionsSubmissionTransactionReferenceProps }, { ViolationTicketV1FinanceDetailsAdhocTransactionsTransactionReference, type ViolationTicketV1FinanceDetailsAdhocTransactionsTransactionReferenceEntityReference, type ViolationTicketV1FinanceDetailsAdhocTransactionsTransactionReferenceProps }, { ViolationTicketV1FinanceDetailsTransactionsSubmission, type ViolationTicketV1FinanceDetailsTransactionsSubmissionEntityReference, type ViolationTicketV1FinanceDetailsTransactionsSubmissionProps }, { ViolationTicketV1FinanceDetailsAdhocTransactionsApproval, type ViolationTicketV1FinanceDetailsAdhocTransactionsApprovalEntityReference, type ViolationTicketV1FinanceDetailsAdhocTransactionsApprovalProps }, { ViolationTicketV1FinanceDetailsAdhocTransactionsFinanceReference, type ViolationTicketV1FinanceDetailsAdhocTransactionsFinanceReferenceEntityReference, type ViolationTicketV1FinanceDetailsAdhocTransactionsFinanceReferenceProps }, { ViolationTicketV1FinanceDetailsRevenueRecognition, type ViolationTicketV1FinanceDetailsRevenueRecognitionEntityReference, type ViolationTicketV1FinanceDetailsRevenueRecognitionProps }, { ViolationTicketV1FinanceDetailsGlTransaction, type ViolationTicketV1FinanceDetailsGlTransactionEntityReference, type ViolationTicketV1FinanceDetailsGlTransactionProps } };
export type { ViolationTicketV1Repository, ViolationTicketV1UnitOfWork, ViolationTicketV1Visa, ViolationTicketV1ActivityDetailEntityReference, ViolationTicketV1ActivityDetailProps, ViolationTicketV1MessageEntityReference, ViolationTicketV1MessageProps, ViolationTicketV1PhotoEntityReference, ViolationTicketV1PhotoProps, ViolationTicketV1FinanceDetailEntityReference, ViolationTicketV1FinanceDetailProps, ViolationTicketV1FinanceDetailsAdhocTransactionsEntityReference, ViolationTicketV1FinanceDetailsAdhocTransactionsProps, ViolationTicketV1RevisionRequestEntityReference, ViolationTicketV1RevisionRequestProps };
//#endregion Exports