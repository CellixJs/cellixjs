...
//#region Exports
export { ViolationTicketV1, type ViolationTicketV1EntityReference, type ViolationTicketV1Props } from './violation-ticket-v1.aggregate.ts';
...
export type { ViolationTicketV1ActivityDetailEntityReference, ViolationTicketV1ActivityDetailProps } from './violation-ticket-v1-activity-detail.ts';
