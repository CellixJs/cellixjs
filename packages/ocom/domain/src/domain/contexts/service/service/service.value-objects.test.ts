...
test.for(feature, ({ Scenario }) => {
	...
	Scenario(
		'Creating a service name with leading and trailing whitespace',
		({ When, Then }) => {
			let value: string;
			When('I create a service name with "  Test Service  "', () => {
				value = new ValueObjects.ServiceName('  Test Service  ').valueOf();
	...
	Scenario(
		'Creating a service name with maximum allowed length',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a service name with more than maximum allowed length',
		({ When, Then }) => {
			let createServiceNameAboveMaxLength: () => void;
			When(
				'I try to create a service name with a string of 101 characters',
				() => {
			...
			Then(
				'an error should be thrown indicating the service name is too long',
				() => {
	...
	Scenario(
		'Creating a service name with minimum allowed length',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a service name with less than minimum allowed length',
		({ When, Then }) => {
			let createServiceNameBelowMinLength: () => void;
			When(
				'I try to create a service name with a string of 2 characters',
				() => {
			...
			Then(
				'an error should be thrown indicating the service name is too short',
				() => {
	...
	Scenario('Creating a service name with null', ({ When, Then }) => {
		...
		Then(
			'an error should be thrown indicating the service name is invalid',
			() => {
	...
	Scenario(
		...
		({ When, Then }) => {
			let value: string;
			When(
				'I create a description with "  A test service description  "',
				() => {
					value = new ValueObjects.Description(
						'  A test service description  ',
					).valueOf();
	...
	Scenario(
		...
		({ When, Then }) => {
			...
			When(
				'I try to create a description with a string of 501 characters',
				() => {
	...
	Scenario(
		'Creating a description with minimum allowed length',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a description with less than minimum allowed length',
		({ When, Then }) => {
			...
			Then(
				'an error should be thrown indicating the description is too short',
				() => {
