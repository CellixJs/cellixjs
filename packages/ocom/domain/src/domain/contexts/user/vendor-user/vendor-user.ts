...
export type { VendorUserContactInformationEntityReference, VendorUserContactInformationProps } from './vendor-user-contact-information.ts';
export type { VendorUserIdentityDetailsEntityReference, VendorUserIdentityDetailsProps } from './vendor-user-identity-details.ts';
export type { VendorUserPersonalInformationEntityReference, VendorUserPersonalInformationProps } from './vendor-user-personal-information.ts';
//#endregion
