...
export interface VendorUserUnitOfWork
	extends UnitOfWork<Passport, VendorUserProps, VendorUser<VendorUserProps>, VendorUserRepository<VendorUserProps>>,
		InitializedUnitOfWork<Passport, VendorUserProps, VendorUser<VendorUserProps>, VendorUserRepository<VendorUserProps>> {}
