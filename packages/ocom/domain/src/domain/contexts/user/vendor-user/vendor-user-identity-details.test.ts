...
test.for(feature, ({ Scenario, Background, BeforeEachScenario }) => {
	...
	Scenario(
		'Creating a new VendorUserIdentityDetails instance',
		({ When, Then, And }) => {
	...
	Scenario(
		...
		({ Given, When, Then }) => {
			Given(
				'an VendorUserIdentityDetails entity with permission to edit own account',
				() => {
					visa = makeVisa({
	...
	Scenario(
		'Changing the lastName with permission to manage vendor users',
		({ Given, When, Then }) => {
			Given(
				'an VendorUserIdentityDetails entity with permission to manage vendor users',
				() => {
					visa = makeVisa({
	...
	Scenario(
		...
		({ Given, When, Then }) => {
			...
			Given(
				'an VendorUserIdentityDetails entity without permission to edit own account or manage vendor users',
				() => {
					visa = makeVisa({
						isEditingOwnAccount: false,
						canManageVendorUsers: false,
	...
	Scenario(
		'Changing the legalNameConsistsOfOneName with permission to manage vendor users',
		({ Given, When, Then }) => {
			Given(
				'an VendorUserIdentityDetails entity with permission to manage vendor users',
				() => {
	...
	Scenario(
		'Changing the restOfName with permission to manage vendor users',
		({ Given, When, Then }) => {
			Given(
				'an VendorUserIdentityDetails entity with permission to manage vendor users',
				() => {
