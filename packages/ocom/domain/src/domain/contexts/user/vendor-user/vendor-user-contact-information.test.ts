...
const feature = await loadFeature(path.resolve(__dirname, 'features/vendor-user-contact-information.feature'));
...
test.for(feature, ({ Scenario, Background, BeforeEachScenario }) => {
	...
	Scenario('Creating a new VendorUserContactInformation instance', ({ When, Then }) => {
		...
		When('I create a new VendorUserContactInformation using getNewInstance with the email', () => {
			newEntity = VendorUserContactInformation.getNewInstance(props, visa, 'alice@cellix.com');
		});
