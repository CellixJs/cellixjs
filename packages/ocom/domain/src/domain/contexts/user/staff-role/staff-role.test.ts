...
function makePermissionsProps(overrides: Partial<StaffRoleProps> = {}): StaffRoleProps {
    return {
...
test.for(feature, ({ Scenario, Background, BeforeEachScenario }) => {
	...
	Scenario('Creating a default tech admin role', ({ When, Then, And }) => {
		...
		When('I create a default tech admin staff role', () => {
			techAdminRole = StaffRole.getNewDefaultTechAdminInstance(makePermissionsProps(), passport);
		});
