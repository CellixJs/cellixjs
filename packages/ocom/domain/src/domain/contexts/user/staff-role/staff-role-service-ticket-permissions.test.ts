...
const feature = await loadFeature(
  path.resolve(__dirname, 'features/staff-role-service-ticket-permissions.feature'),
);
...
test.for(feature, ({ Scenario, Background, BeforeEachScenario }) => {
  ...
  let entity: StaffRoleServiceTicketPermissions;

  BeforeEachScenario(() => {
    visa = makeVisa();
    props = makeProps();
    entity = new StaffRoleServiceTicketPermissions(props, visa);
  });
