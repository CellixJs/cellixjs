...
export type { StaffRolePermissionsProps, StaffRolePermissionsEntityReference } from './staff-role-permissions.ts';
export type { StaffRoleCommunityPermissionsProps, StaffRoleCommunityPermissionsEntityReference } from './staff-role-community-permissions.ts';
export type { StaffRolePropertyPermissionsProps, StaffRolePropertyPermissionsEntityReference } from './staff-role-property-permissions.ts';
export type { StaffRoleServicePermissionsProps, StaffRoleServicePermissionsEntityReference } from './staff-role-service-permissions.ts';
export type { StaffRoleServiceTicketPermissionsProps, StaffRoleServiceTicketPermissionsEntityReference } from './staff-role-service-ticket-permissions.ts';
export type { StaffRoleViolationTicketPermissionsProps, StaffRoleViolationTicketPermissionsEntityReference } from './staff-role-violation-ticket-permissions.ts';
//#endregion
