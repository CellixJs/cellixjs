...
test.for(feature, ({ Scenario }) => {
	...
	Scenario(
		'Creating a member name with leading and trailing whitespace',
		({ When, Then }) => {
			let value: string;
			When('I create a member name with "  Alice  "', () => {
				value = new ValueObjects.MemberName('  Alice  ').valueOf();
	...
	Scenario(
		'Creating a member name with maximum allowed length',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a member name with more than maximum allowed length',
		({ When, Then }) => {
			let createMemberNameAboveMaxLength: () => void;
			When(
				'I try to create a member name with a string of 201 characters',
				() => {
			...
			Then(
				'an error should be thrown indicating the member name is too long',
				() => {
	...
	Scenario(
		'Creating a member name with minimum allowed length',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a member name with less than minimum allowed length',
		({ When, Then }) => {
			...
			Then(
				'an error should be thrown indicating the member name is too short',
				() => {
	...
	Scenario('Creating a member name with null', ({ When, Then }) => {
		...
		Then(
			'an error should be thrown indicating the member name is invalid',
			() => {
	...
	Scenario(
		'Creating a CyberSourceCustomerId with valid value',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a CyberSourceCustomerId with maximum allowed length',
		({ When, Then }) => {
			let value: string;
			When(
				'I create a CyberSourceCustomerId with a string of 50 characters',
				() => {
					value = new ValueObjects.CyberSourceCustomerId(
						'a'.repeat(50),
					).valueOf();
				},
			);
	...
	Scenario(
		'Creating a CyberSourceCustomerId with more than maximum allowed length',
		({ When, Then }) => {
			let createCyberSourceCustomerIdAboveMaxLength: () => void;
			When(
				'I try to create a CyberSourceCustomerId with a string of 51 characters',
				() => {
			...
			Then(
				'an error should be thrown indicating the CyberSourceCustomerId is too long',
				() => {
	...
	Scenario(
		'Creating a CyberSourceCustomerId with minimum allowed length',
		({ When, Then }) => {
			let value: string;
			When(
				'I create a CyberSourceCustomerId with a string of 1 character',
				() => {
	...
	Scenario(
		'Creating a CyberSourceCustomerId with less than minimum allowed length',
		({ When, Then }) => {
			let createCyberSourceCustomerIdBelowMinLength: () => void;
			When(
				'I try to create a CyberSourceCustomerId with an empty string',
				() => {
			...
			Then(
				'an error should be thrown indicating the CyberSourceCustomerId is too short',
				() => {
					expect(createCyberSourceCustomerIdBelowMinLength).toThrow(
						'Too short',
					);
				},
			);
	...
	Scenario('Creating a CyberSourceCustomerId with null', ({ When, Then }) => {
		...
		Then(
			'an error should be thrown indicating the CyberSourceCustomerId is invalid',
			() => {
	...
	Scenario(
		'Creating a CyberSourceCustomerId with undefined',
		({ When, Then }) => {
			...
			Then(
				'an error should be thrown indicating the CyberSourceCustomerId is invalid',
				() => {
					expect(createCyberSourceCustomerIdUndefined).toThrow(
