...
export interface EndUserRoleViolationTicketPermissionsProps extends Omit<CaseDomainPermissions, 'isEditingOwnTicket' | 'isEditingAssignedTicket' | 'isSystemAccount'>, ValueObjectProps {}
