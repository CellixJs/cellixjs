...
export interface EndUserRoleUnitOfWork
	extends UnitOfWork<Passport, EndUserRoleProps, EndUserRole<EndUserRoleProps>, EndUserRoleRepository<EndUserRoleProps>>,
		InitializedUnitOfWork<Passport, EndUserRoleProps, EndUserRole<EndUserRoleProps>, EndUserRoleRepository<EndUserRoleProps>> {}
