...
const feature = await loadFeature(
	path.resolve(
		__dirname,
		'features/vendor-user-role-community-permissions.feature',
	),
);
...
test.for(feature, ({ Scenario, Background, BeforeEachScenario }) => {
	...
	Background(({ Given, And }) => {
		Given(
			'valid VendorUserRoleCommunityPermissionsProps with all permission flags set to false',
			() => {
				props = makeProps();
			},
		);
	...
	// canManageVendorUserRolesAndPermissions
	Scenario(
		'Changing canManageVendorUserRolesAndPermissions with manage vendor user roles permission',
		({ Given, When, Then }) => {
			Given(
				'an VendorUserRoleCommunityPermissions entity with permission to manage vendor user roles',
				() => {
	...
	Scenario(
		'Changing canManageVendorUserRolesAndPermissions with system account permission',
		({ Given, When, Then }) => {
			Given(
				'an VendorUserRoleCommunityPermissions entity with system account permission',
				() => {
					visa = makeVisa({
						canManageVendorUserRolesAndPermissions: false,
	...
	Scenario(
		'Changing canManageVendorUserRolesAndPermissions without permission',
		({ Given, When, Then }) => {
			let setPermission: () => void;
			Given(
				'an VendorUserRoleCommunityPermissions entity without permission to manage vendor user roles or system account',
				() => {
					visa = makeVisa({
						canManageVendorUserRolesAndPermissions: false,
			...
			When(
				'I try to set canManageVendorUserRolesAndPermissions to true',
				() => {
					setPermission = () => {
						entity.canManageVendorUserRolesAndPermissions = true;
					};
	...
	Scenario(
		'Changing canManageCommunitySettings with manage vendor user roles permission',
		({ Given, When, Then }) => {
			Given(
				'an VendorUserRoleCommunityPermissions entity with permission to manage vendor user roles',
				() => {
	...
	Scenario(
		'Changing canManageCommunitySettings with system account permission',
		({ Given, When, Then }) => {
			Given(
				'an VendorUserRoleCommunityPermissions entity with system account permission',
				() => {
	...
	Scenario(
		'Changing canManageCommunitySettings without permission',
		({ Given, When, Then }) => {
			let setPermission: () => void;
			Given(
				'an VendorUserRoleCommunityPermissions entity without permission to manage vendor user roles or system account',
	...
	Scenario(
		'Changing canManageSiteContent with manage vendor user roles permission',
		({ Given, When, Then }) => {
			Given(
				'an VendorUserRoleCommunityPermissions entity with permission to manage vendor user roles',
				() => {
	...
	Scenario(
		'Changing canManageSiteContent with system account permission',
		({ Given, When, Then }) => {
			Given(
				'an VendorUserRoleCommunityPermissions entity with system account permission',
				() => {
	...
	Scenario(
		'Changing canManageSiteContent without permission',
		({ Given, When, Then }) => {
			let setPermission: () => void;
			Given(
				'an VendorUserRoleCommunityPermissions entity without permission to manage vendor user roles or system account',
	...
	// canManageMembers
	Scenario(
		'Changing canManageMembers with manage vendor user roles permission',
		({ Given, When, Then }) => {
			Given(
				'an VendorUserRoleCommunityPermissions entity with permission to manage vendor user roles',
				() => {
	...
	Scenario(
		'Changing canManageMembers with system account permission',
		({ Given, When, Then }) => {
			Given(
				'an VendorUserRoleCommunityPermissions entity with system account permission',
				() => {
	...
	Scenario(
		'Changing canManageMembers without permission',
		({ Given, When, Then }) => {
			let setPermission: () => void;
			Given(
				'an VendorUserRoleCommunityPermissions entity without permission to manage vendor user roles or system account',
	...
	Scenario(
		'Changing canEditOwnMemberProfile with manage vendor user roles permission',
		({ Given, When, Then }) => {
			Given(
				'an VendorUserRoleCommunityPermissions entity with permission to manage vendor user roles',
				() => {
	...
	Scenario(
		'Changing canEditOwnMemberProfile with system account permission',
		({ Given, When, Then }) => {
			Given(
				'an VendorUserRoleCommunityPermissions entity with system account permission',
				() => {
	...
	Scenario(
		'Changing canEditOwnMemberProfile without permission',
		({ Given, When, Then }) => {
			let setPermission: () => void;
			Given(
				'an VendorUserRoleCommunityPermissions entity without permission to manage vendor user roles or system account',
	...
	Scenario(
		'Changing canEditOwnMemberAccounts with manage vendor user roles permission',
		({ Given, When, Then }) => {
			Given(
				'an VendorUserRoleCommunityPermissions entity with permission to manage vendor user roles',
				() => {
	...
	Scenario(
		'Changing canEditOwnMemberAccounts with system account permission',
		({ Given, When, Then }) => {
			Given(
				'an VendorUserRoleCommunityPermissions entity with system account permission',
				() => {
	...
	Scenario(
		'Changing canEditOwnMemberAccounts without permission',
		({ Given, When, Then }) => {
			let setPermission: () => void;
			Given(
				'an VendorUserRoleCommunityPermissions entity without permission to manage vendor user roles or system account',
