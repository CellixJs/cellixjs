...
const feature = await loadFeature(
	path.resolve(
		__dirname,
		'features/end-user-role-community-permissions.feature',
	),
);
...
test.for(feature, ({ Scenario, Background, BeforeEachScenario }) => {
	...
	Background(({ Given, And }) => {
		Given(
			'valid EndUserRoleCommunityPermissionsProps with all permission flags set to false',
			() => {
				props = makeProps();
			},
		);
	...
	// canManageEndUserRolesAndPermissions
	Scenario(
		'Changing canManageEndUserRolesAndPermissions with manage end user roles permission',
		({ Given, When, Then }) => {
			Given(
				'an EndUserRoleCommunityPermissions entity with permission to manage end user roles',
				() => {
	...
	Scenario(
		'Changing canManageEndUserRolesAndPermissions with system account permission',
		({ Given, When, Then }) => {
			Given(
				'an EndUserRoleCommunityPermissions entity with system account permission',
				() => {
					visa = makeVisa({
						canManageEndUserRolesAndPermissions: false,
	...
	Scenario(
		'Changing canManageEndUserRolesAndPermissions without permission',
		({ Given, When, Then }) => {
			let setPermission: () => void;
			Given(
				'an EndUserRoleCommunityPermissions entity without permission to manage end user roles or system account',
				() => {
					visa = makeVisa({
						canManageEndUserRolesAndPermissions: false,
	...
	Scenario(
		'Changing canManageCommunitySettings with manage end user roles permission',
		({ Given, When, Then }) => {
			Given(
				'an EndUserRoleCommunityPermissions entity with permission to manage end user roles',
				() => {
	...
	Scenario(
		'Changing canManageSiteContent with manage end user roles permission',
		({ Given, When, Then }) => {
			Given(
				'an EndUserRoleCommunityPermissions entity with permission to manage end user roles',
				() => {
	...
	// canManageMembers
	Scenario(
		'Changing canManageMembers with manage end user roles permission',
		({ Given, When, Then }) => {
			Given(
				'an EndUserRoleCommunityPermissions entity with permission to manage end user roles',
				() => {
	...
	Scenario(
		'Changing canEditOwnMemberProfile with manage end user roles permission',
		({ Given, When, Then }) => {
			Given(
				'an EndUserRoleCommunityPermissions entity with permission to manage end user roles',
				() => {
	...
	Scenario(
		'Changing canEditOwnMemberAccounts with manage end user roles permission',
		({ Given, When, Then }) => {
			Given(
				'an EndUserRoleCommunityPermissions entity with permission to manage end user roles',
				() => {
