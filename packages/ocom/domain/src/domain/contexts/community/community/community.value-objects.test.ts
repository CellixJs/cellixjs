...
test.for(feature, ({ Scenario }) => {
	...
	Scenario(
		'Creating a name with leading and trailing whitespace',
		({ When, Then }) => {
			let value: string;
			When('I create a name with "  Cellix Community  "', () => {
				value = new ValueObjects.Name('  Cellix Community  ').valueOf();
	...
	Scenario(
		'Creating a name with more than maximum allowed length',
		({ When, Then }) => {
	...
	Scenario(
		'Creating a name with less than minimum allowed length',
		({ When, Then }) => {
	...
	Scenario(
		'Creating a domain with leading and trailing whitespace',
		({ When, Then }) => {
			let value: string;
			When('I create a domain with "  cellix.com  "', () => {
				value = new ValueObjects.Domain('  cellix.com  ').valueOf();
	...
	Scenario(
		'Creating a domain with maximum allowed length',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a domain with more than maximum allowed length',
		({ When, Then }) => {
			...
			Then(
				'an error should be thrown indicating the domain is too long',
				() => {
	...
	Scenario(
		'Creating a domain with minimum allowed length',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a domain with less than minimum allowed length',
		({ When, Then }) => {
			...
			Then(
				'an error should be thrown indicating the domain is too short',
				() => {
	...
	// WhiteLabelDomain
	Scenario(
		'Creating a white label domain with valid value',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a white label domain with leading and trailing whitespace',
		({ When, Then }) => {
			let value: string;
			When(
				'I create a white label domain with "  whitelabel.cellix.com  "',
				() => {
					value = new ValueObjects.WhiteLabelDomain(
						'  whitelabel.cellix.com  ',
					// biome-ignore lint/plugin/no-type-assertion: test file
	...
	Scenario(
		'Creating a white label domain with maximum allowed length',
		({ When, Then }) => {
			let value: string;
			When(
				'I create a white label domain with a string of 500 characters',
				() => {
					value = new ValueObjects.WhiteLabelDomain(
						'a'.repeat(500),
					// biome-ignore lint/plugin/no-type-assertion: test file
	...
	Scenario(
		'Creating a white label domain with more than maximum allowed length',
		({ When, Then }) => {
			let createWhiteLabelDomainAboveMaxLength: () => void;
			When(
				'I try to create a white label domain with a string of 501 characters',
				() => {
			...
			Then(
				'an error should be thrown indicating the white label domain is too long',
				() => {
	...
	Scenario(
		'Creating a white label domain with minimum allowed length',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a white label domain with less than minimum allowed length',
		({ When, Then }) => {
			...
			Then(
				'an error should be thrown indicating the white label domain is too short',
				() => {
	...
	Scenario('Creating a white label domain with undefined', ({ When, Then }) => {
		...
		Then(
			'an error should be thrown indicating the white label domain is invalid',
			() => {
				expect(createWhiteLabelDomainWithUndefined).throws(
					/Wrong raw value type/i,
				);
			},
		);
	});
	...
	Scenario(
		'Creating a handle with leading and trailing whitespace',
		({ When, Then }) => {
			let value: string;
			When('I create a handle with "  cellix  "', () => {
				// biome-ignore lint/plugin/no-type-assertion: test file
	...
	Scenario(
		'Creating a handle with maximum allowed length',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a handle with more than maximum allowed length',
		({ When, Then }) => {
			...
			Then(
				'an error should be thrown indicating the handle is too long',
				() => {
	...
	Scenario(
		'Creating a handle with minimum allowed length',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a handle with less than minimum allowed length',
		({ When, Then }) => {
			...
			Then(
				'an error should be thrown indicating the handle is too short',
				() => {
