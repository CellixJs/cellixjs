...
export interface CommunityUnitOfWork
	extends UnitOfWork<Passport, CommunityProps, Community<CommunityProps>, CommunityRepository<CommunityProps>>,
		InitializedUnitOfWork<Passport, CommunityProps, Community<CommunityProps>, CommunityRepository<CommunityProps>> {}
