...
test.for(feature, ({ Scenario }) => {
	...
	Scenario(
		'Creating a property name with leading and trailing whitespace',
		({ When, Then }) => {
			let value: string;
			When('I create a property name with "  Test Property  "', () => {
				value = new ValueObjects.PropertyName('  Test Property  ').valueOf();
	...
	Scenario(
		'Creating a property name with maximum allowed length',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a property name with more than maximum allowed length',
		({ When, Then }) => {
			let createPropertyNameAboveMaxLength: () => void;
			When(
				'I try to create a property name with a string of 101 characters',
				() => {
			...
			Then(
				'an error should be thrown indicating the property name is too long',
				() => {
	...
	Scenario(
		'Creating a property name with minimum allowed length',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a property name with less than minimum allowed length',
		({ When, Then }) => {
			...
			Then(
				'an error should be thrown indicating the property name is too short',
				() => {
	...
	Scenario('Creating a property name with null', ({ When, Then }) => {
		...
		Then(
			'an error should be thrown indicating the property name is invalid',
			() => {
	...
	Scenario('Creating a property name with undefined', ({ When, Then }) => {
		...
		Then(
			'an error should be thrown indicating the property name is invalid',
			() => {
				expect(createPropertyNameWithUndefined).toThrow(
	...
	Scenario(
		'Creating a property type with leading and trailing whitespace',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a property type with maximum allowed length',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a property type with more than maximum allowed length',
		({ When, Then }) => {
			let createPropertyTypeAboveMaxLength: () => void;
			When(
				'I try to create a property type with a string of 101 characters',
				() => {
			...
			Then(
				'an error should be thrown indicating the property type is too long',
				() => {
	...
	Scenario(
		'Creating a property type with minimum allowed length',
		({ When, Then }) => {
			let value: string;
	...
	Scenario(
		'Creating a property type with less than minimum allowed length',
		({ When, Then }) => {
			...
			Then(
				'an error should be thrown indicating the property type is too short',
				() => {
	...
	Scenario('Creating a property type with null', ({ When, Then }) => {
		...
		Then(
			'an error should be thrown indicating the property type is invalid',
			() => {
	...
	Scenario('Creating a property type with undefined', ({ When, Then }) => {
		...
		Then(
			'an error should be thrown indicating the property type is invalid',
			() => {
				expect(createPropertyTypeWithUndefined).toThrow(
					/Wrong raw value type/i,
				);
			},
		);
