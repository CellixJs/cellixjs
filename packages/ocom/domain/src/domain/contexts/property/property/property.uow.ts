...
export interface PropertyUnitOfWork
	extends UnitOfWork<Passport, PropertyProps, Property<PropertyProps>, PropertyRepository<PropertyProps>>,
		InitializedUnitOfWork<Passport, PropertyProps, Property<PropertyProps>, PropertyRepository<PropertyProps>> {}
