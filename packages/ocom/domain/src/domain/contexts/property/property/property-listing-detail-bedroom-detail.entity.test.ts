...
const feature = await loadFeature(
	path.resolve(
		__dirname,
		'features/property-listing-detail-bedroom-detail.entity.feature',
	),
);
...
test.for(feature, ({ Scenario }) => {
	...
	Scenario('Creating a bedroom detail with valid props', ({ When, Then }) => {
		...
		When(
			'I create a bedroom detail with valid room name and bed descriptions',
			() => {
				bedroom =
					new PropertyListingDetailBedroomDetailEntity.PropertyListingDetailBedroomDetail(
						validProps,
						mockVisa,
					);
			},
		...
		Then('the bedroom detail should be created successfully', () => {
			expect(bedroom).toBeInstanceOf(
				PropertyListingDetailBedroomDetailEntity.PropertyListingDetailBedroomDetail,
			);
	...
	Scenario(
		'Setting room name with proper permissions',
		({ Given, When, Then }) => {
			let bedroom: PropertyListingDetailBedroomDetailEntity.PropertyListingDetailBedroomDetail;
	...
	Scenario(
		'Setting room name without proper permissions',
		({ Given, When, Then }) => {
			let bedroom: PropertyListingDetailBedroomDetailEntity.PropertyListingDetailBedroomDetail;
			Given('a bedroom detail exists', () => {
				bedroom =
	...
	Scenario(
		'Setting bed descriptions with proper permissions',
		({ Given, When, Then }) => {
			let bedroom: PropertyListingDetailBedroomDetailEntity.PropertyListingDetailBedroomDetail;
			Given('a bedroom detail exists', () => {
				bedroom =
			...
			When('I set the bed descriptions with proper permissions', () => {
				vi.mocked(mockVisa.determineIf).mockReturnValue(true);
				bedroom.bedDescriptions = new ValueObjects.BedDescriptions([
					'Twin bed',
				]);
			});
	...
	Scenario(
		'Setting bed descriptions without proper permissions',
		({ Given, When, Then }) => {
			let bedroom: PropertyListingDetailBedroomDetailEntity.PropertyListingDetailBedroomDetail;
			Given('a bedroom detail exists', () => {
				bedroom =
			...
			When(
				'I try to set the bed descriptions without proper permissions',
				() => {
					vi.mocked(mockVisa.determineIf).mockReturnValue(false);
					expect(() => {
						bedroom.bedDescriptions = new ValueObjects.BedDescriptions([
