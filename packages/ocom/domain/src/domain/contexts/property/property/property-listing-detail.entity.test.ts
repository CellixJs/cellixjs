...
test.for(feature, ({ Scenario }) => {
	...
	const validProps: PropertyListingDetailEntity.PropertyListingDetailProps = {
		...
		bedroomDetails: {
			...
			removeItem: vi.fn(),
		} as unknown as DomainSeedwork.PropArray<PropertyListingDetailBedroomDetailProps>,
		bathrooms: 2,
		squareFeet: null,
		yearBuilt: null,
		lotSize: null,
		...
		additionalAmenities: {
			...
			removeItem: vi.fn(),
		} as unknown as DomainSeedwork.PropArray<PropertyListingDetailAdditionalAmenity>,
		images: ['image1.jpg'],
		video: null,
		floorPlan: null,
	...
	Scenario(
		'Creating a property listing detail with valid props',
		({ When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			When('I create a property listing detail with valid props', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
					validProps,
					mockVisa,
				);
			});
			Then('the property listing detail should be created successfully', () => {
				expect(listing).toBeInstanceOf(
					PropertyListingDetailEntity.PropertyListingDetail,
				);
	...
	Scenario(
		'Setting price without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Requesting new bedroom with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
	...
	Scenario(
		'Requesting new bedroom without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Requesting new additional amenity with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
	...
	Scenario(
		'Removing image with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting rentHigh with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting rentHigh without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting rentLow with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting rentLow without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting lease without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting maxGuests with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting maxGuests without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting bedrooms with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting bedrooms without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting bathrooms with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting bathrooms without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting squareFeet with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting squareFeet without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting yearBuilt with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting yearBuilt without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting lotSize with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting lotSize without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		...
		({ Given, When, Then }) => {
			...
			When('I set the description with proper permissions', () => {
				mockVisa.determineIf.mockReturnValue(true);
				listing.description = new ValueObjects.Description(
					'Updated description',
				);
			});
	...
	Scenario(
		'Setting description without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting amenities with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When('I set the amenities with proper permissions', () => {
				mockVisa.determineIf.mockReturnValue(true);
				listing.amenities = new ValueObjects.Amenities([
					'pool',
					'gym',
					'parking',
				]);
	...
	Scenario(
		'Setting amenities without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting images with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When('I set the images with proper permissions', () => {
				mockVisa.determineIf.mockReturnValue(true);
				listing.images = new ValueObjects.Images([
					'new-image1.jpg',
					'new-image2.jpg',
				]);
			});
	...
	Scenario(
		'Setting images without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting video without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting floorPlan with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting floorPlan without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting floorPlanImages with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When('I set the floorPlanImages with proper permissions', () => {
				mockVisa.determineIf.mockReturnValue(true);
				listing.floorPlanImages = new ValueObjects.FloorPlanImages([
					'floor1.jpg',
					'floor2.jpg',
				]);
			});
	...
	Scenario(
		'Setting floorPlanImages without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When(
				'I try to set the floorPlanImages without proper permissions',
				() => {
					mockVisa.determineIf.mockReturnValue(false);
					expect(() => {
						listing.floorPlanImages = new ValueObjects.FloorPlanImages([
	...
	Scenario(
		'Setting listingAgent with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting listingAgent without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Setting listingAgentPhone with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When('I set the listingAgentPhone with proper permissions', () => {
				mockVisa.determineIf.mockReturnValue(true);
				listing.listingAgentPhone = new ValueObjects.ListingAgentPhone(
					'555-1234',
				);
			});
	...
	Scenario(
		'Setting listingAgentPhone without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When(
				'I try to set the listingAgentPhone without proper permissions',
				() => {
					mockVisa.determineIf.mockReturnValue(false);
					expect(() => {
						listing.listingAgentPhone = new ValueObjects.ListingAgentPhone(
	...
	Scenario(
		'Setting listingAgentEmail with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When('I set the listingAgentEmail with proper permissions', () => {
				mockVisa.determineIf.mockReturnValue(true);
				listing.listingAgentEmail = new ValueObjects.ListingAgentEmail(
					'agent@example.com',
				);
			});
	...
	Scenario(
		'Setting listingAgentEmail without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When(
				'I try to set the listingAgentEmail without proper permissions',
				() => {
					mockVisa.determineIf.mockReturnValue(false);
					expect(() => {
						listing.listingAgentEmail = new ValueObjects.ListingAgentEmail(
	...
	Scenario(
		'Setting listingAgentWebsite with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When('I set the listingAgentWebsite with proper permissions', () => {
				mockVisa.determineIf.mockReturnValue(true);
				listing.listingAgentWebsite = new ValueObjects.ListingAgentWebsite(
					'https://agent.com',
				);
			});
	...
	Scenario(
		'Setting listingAgentWebsite without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When(
				'I try to set the listingAgentWebsite without proper permissions',
				() => {
					mockVisa.determineIf.mockReturnValue(false);
					expect(() => {
						listing.listingAgentWebsite = new ValueObjects.ListingAgentWebsite(
	...
	Scenario(
		'Setting listingAgentCompany with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When('I set the listingAgentCompany with proper permissions', () => {
				mockVisa.determineIf.mockReturnValue(true);
				listing.listingAgentCompany = new ValueObjects.ListingAgentCompany(
					'Real Estate Co',
				);
			});
	...
	Scenario(
		'Setting listingAgentCompany without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When(
				'I try to set the listingAgentCompany without proper permissions',
				() => {
					mockVisa.determineIf.mockReturnValue(false);
					expect(() => {
						listing.listingAgentCompany = new ValueObjects.ListingAgentCompany(
	...
	Scenario(
		'Setting listingAgentCompanyPhone with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When('I set the listingAgentCompanyPhone with proper permissions', () => {
				mockVisa.determineIf.mockReturnValue(true);
				listing.listingAgentCompanyPhone =
					new ValueObjects.ListingAgentCompanyPhone('555-5678');
			});
	...
	Scenario(
		'Setting listingAgentCompanyPhone without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When(
				'I try to set the listingAgentCompanyPhone without proper permissions',
				() => {
					mockVisa.determineIf.mockReturnValue(false);
					expect(() => {
						listing.listingAgentCompanyPhone =
	...
	Scenario(
		'Setting listingAgentCompanyEmail with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When('I set the listingAgentCompanyEmail with proper permissions', () => {
				mockVisa.determineIf.mockReturnValue(true);
				listing.listingAgentCompanyEmail =
					new ValueObjects.ListingAgentCompanyEmail('company@example.com');
			});
	...
	Scenario(
		'Setting listingAgentCompanyEmail without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When(
				'I try to set the listingAgentCompanyEmail without proper permissions',
				() => {
					mockVisa.determineIf.mockReturnValue(false);
					expect(() => {
						listing.listingAgentCompanyEmail =
	...
	Scenario(
		'Setting listingAgentCompanyWebsite with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When(
				'I set the listingAgentCompanyWebsite with proper permissions',
				() => {
					mockVisa.determineIf.mockReturnValue(true);
					listing.listingAgentCompanyWebsite =
						new ValueObjects.ListingAgentCompanyWebsite('https://company.com');
				},
			);
	...
	Scenario(
		'Setting listingAgentCompanyWebsite without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When(
				'I try to set the listingAgentCompanyWebsite without proper permissions',
				() => {
					mockVisa.determineIf.mockReturnValue(false);
					expect(() => {
						listing.listingAgentCompanyWebsite =
							new ValueObjects.ListingAgentCompanyWebsite(
								'https://company.com',
							);
					}).toThrow(
						'You do not have permission to update this property listing',
	...
	Scenario(
		'Setting listingAgentCompanyAddress with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When(
				'I set the listingAgentCompanyAddress with proper permissions',
				() => {
					mockVisa.determineIf.mockReturnValue(true);
					listing.listingAgentCompanyAddress =
						new ValueObjects.ListingAgentCompanyAddress(
							'123 Main St, City, State',
						);
				},
			);
			Then('the listingAgentCompanyAddress should be updated', () => {
				expect(listing.listingAgentCompanyAddress).toBe(
					'123 Main St, City, State',
				);
			});
		},
	...
	Scenario(
		'Setting listingAgentCompanyAddress without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When(
				'I try to set the listingAgentCompanyAddress without proper permissions',
				() => {
					mockVisa.determineIf.mockReturnValue(false);
					expect(() => {
						listing.listingAgentCompanyAddress =
	...
	Scenario(
		'Requesting remove bedroom with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
	...
	Scenario(
		'Requesting remove bedroom without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When(
				'I try to request remove a bedroom without proper permissions',
				() => {
					mockVisa.determineIf.mockReturnValue(false);
					const bedroomProps = validProps.bedroomDetails
						.items[0] as PropertyListingDetailBedroomDetailProps;
	...
	Scenario(
		'Requesting remove additional amenity with proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When(
				'I request to remove an additional amenity with proper permissions',
				() => {
					mockVisa.determineIf.mockReturnValue(true);
	...
	Scenario(
		'Requesting remove additional amenity without proper permissions',
		({ Given, When, Then }) => {
			let listing: PropertyListingDetailEntity.PropertyListingDetail;
			Given('a property listing detail exists', () => {
				listing = new PropertyListingDetailEntity.PropertyListingDetail(
			...
			When(
				'I try to request remove an additional amenity without proper permissions',
				() => {
					mockVisa.determineIf.mockReturnValue(false);
					const amenityProps = validProps.additionalAmenities
						.items[0] as PropertyListingDetailAdditionalAmenityProps;
