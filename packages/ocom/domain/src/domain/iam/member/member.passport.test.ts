...
import type { ServiceTicketV1EntityReference } from '../../contexts/case.ts';
import type { ViolationTicketV1EntityReference } from '../../contexts/case.ts';
import type { CommunityEntityReference } from '../../contexts/community.ts';
...
import type { StaffRoleEntityReference } from '../../contexts/user.ts';
import type { StaffUserEntityReference } from '../../contexts/user.ts';
import type { VendorUserEntityReference } from '../../contexts/user.ts';
