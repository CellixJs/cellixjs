...
import type { CommunityEntityReference } from '../../contexts/community/community-aggregate.ts';
...
import type { StaffRoleEntityReference } from '../../contexts/user/staff-role.ts';
import type { StaffUserEntityReference } from '../../contexts/user/staff-user.ts';
import type { VendorUserEntityReference } from '../../contexts/user/vendor-user.ts';
