...
const feature = await loadFeature(path.resolve(__dirname, 'features/guest.user.passport.feature'));
...
test.for(feature, ({ Scenario }) => {
	...
	Scenario('Creating GuestUserPassport and getting visa for end user', ({ When, Then, And }) => {
	...
	Scenario('Creating GuestUserPassport and getting visa for staff user', ({ When, Then, And }) => {
		When('I create a GuestUserPassport', () => {
			passport = new GuestUserPassport();
		});
	...
	Scenario('Creating GuestUserPassport and getting visa for staff role', ({ When, Then, And }) => {
		When('I create a GuestUserPassport', () => {
			passport = new GuestUserPassport();
		});
	...
	Scenario('Creating GuestUserPassport and getting visa for vendor user', ({ When, Then, And }) => {
		When('I create a GuestUserPassport', () => {
			passport = new GuestUserPassport();
		});
