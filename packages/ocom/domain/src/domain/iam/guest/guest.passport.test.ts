...
const feature = await loadFeature(path.resolve(__dirname, 'features/guest.passport.feature'));
...
test.for(feature, ({ Scenario, BeforeEachScenario }) => {
	...
	Scenario('Creating GuestPassport and accessing property passport', ({ When, Then, And }) => {
		When('I create a GuestPassport', () => {
			passport = new GuestPassport();
		});
	...
	Scenario('Creating GuestPassport and accessing case passport', ({ When, Then, And }) => {
		When('I create a GuestPassport', () => {
			passport = new GuestPassport();
		});
