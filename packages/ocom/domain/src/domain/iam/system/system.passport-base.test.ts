...
test.for(feature, ({ Scenario }) => {
	...
	Scenario(
		...
		({ Given, When, Then, And }) => {
			Given(
				'I have permissions object with canManageMembers true and canManageCommunities false',
				() => {
					permissions = {
	...
	Scenario(
		...
		({ Given, When, Then, And }) => {
			Given(
				'I have a partial permissions object with only canManageMembers true',
				() => {
					permissions = {
						canManageMembers: true,
					};
