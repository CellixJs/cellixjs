import { DeleteOutlined, PlusOutlined, UserAddOutlined, UsergroupAddOutlined } from '@ant-design/icons';
import { Button, Divider, Form, Input, InputNumber, Modal, Space, Tabs, Typography } from 'antd';
