...
export const applyUserPermissions = (
	staffRole: Domain.Contexts.User.StaffRole.StaffRole<Domain.Contexts.User.StaffRole.StaffRoleProps>,
	permissions?: StaffRoleCommandUserPermissions,
) => {
	if (!permissions) return;
	...
	if (permissions.canAssignStaffRoles !== undefined) { userPermissions.canAssignStaffRoles = permissions.canAssignStaffRoles; }
	if (permissions.canViewStaffUsers !== undefined) { userPermissions.canViewStaffUsers = permissions.canViewStaffUsers; }
};

export const applyRolePermissions = (
	staffRole: Domain.Contexts.User.StaffRole.StaffRole<Domain.Contexts.User.StaffRole.StaffRoleProps>,
	permissions?: StaffRoleCommandRolePermissions,
) => {
	if (!permissions) return;
...
export const applyFinancePermissions = (
	staffRole: Domain.Contexts.User.StaffRole.StaffRole<Domain.Contexts.User.StaffRole.StaffRoleProps>,
	permissions?: StaffRoleCommandFinancePermissions,
) => {
	if (!permissions) return;
...
export const applyTechAdminPermissions = (
	staffRole: Domain.Contexts.User.StaffRole.StaffRole<Domain.Contexts.User.StaffRole.StaffRoleProps>,
	permissions?: StaffRoleCommandTechAdminPermissions,
) => {
	if (!permissions) return;
