				...
				const staffRole = await context.applicationServices.User.StaffRole.create({
					...
					permissions: {
						...
						techAdmin: {
							...
							canViewDatabaseDocuments: args.input.permissions?.techAdminPermissions?.canViewDatabaseDocuments ?? false,
				...
				const staffRole = await context.applicationServices.User.StaffRole.update({
					...
					permissions: {
						...
						techAdmin: {
							...
							...(args.input.permissions?.techAdminPermissions?.canViewDatabaseDocuments != null ? { canViewDatabaseDocuments: args.input.permissions.techAdminPermissions.canViewDatabaseDocuments } : {}),
