 ...
 */
export const domainShouldHaveNoCycles = () =>
  projectFiles()
    .inFolder('**/domain/**')
    .should()
    .haveNoCycles();
 ...
 */
export const applicationShouldHaveNoCycles = () =>
  projectFiles()
 ...
 */
export const servicesShouldHaveNoCycles = () =>
  projectFiles()
    .inFolder('**/service-*/**')
    .should()
    .haveNoCycles();
 ...
 */
export const apiShouldHaveNoCycles = () =>
  projectFiles()
    .inFolder('**/api/**')
    .should()
    .haveNoCycles();

export const apiGraphqlShouldHaveNoCycles = () =>
  projectFiles()
    .inFolder('**/api-graphql/**')
    .should()
    .haveNoCycles();

export const apiRestShouldHaveNoCycles = () =>
  projectFiles()
    .inFolder('**/api-rest/**')
    .should()
    .haveNoCycles();
 ...
 */
export const uiShouldHaveNoCycles = () =>
  projectFiles()
    .inFolder('**/ui-*/**')
    .should()
    .haveNoCycles();

export const uiComponentsShouldHaveNoCycles = () =>
  projectFiles()
 ...
 */
export const seedworkShouldHaveNoCycles = () =>
  projectFiles()
 ...
 */
export const packagesShouldHaveNoCycles = () =>
  projectFiles()
    .inFolder('packages/**')
    .should()
    .haveNoCycles();
