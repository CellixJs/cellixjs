 ...
 */
export const domainShouldNotDependOnInfrastructure = () => 
  projectFiles()
    .inFolder('**/domain/**')
    .shouldNot()
    .dependOnFiles()
...
export const domainShouldNotDependOnApplication = () =>
  projectFiles()
    .inFolder('**/domain/**')
    .shouldNot()
    .dependOnFiles()
...
export const domainShouldNotDependOnApi = () =>
  projectFiles()
    .inFolder('**/domain/**')
    .shouldNot()
    .dependOnFiles()
...
export const domainShouldNotDependOnUI = () =>
  projectFiles()
    .inFolder('**/domain/**')
    .shouldNot()
    .dependOnFiles()
 ...
 */
export const applicationShouldNotDependOnInfrastructure = () =>
  projectFiles()
    .inFolder('**/application/**')
    .shouldNot()
    .dependOnFiles()
...
export const applicationShouldNotDependOnUI = () =>
  projectFiles()
    .inFolder('**/application/**')
    .shouldNot()
    .dependOnFiles()
...
export const applicationShouldNotDependOnApi = () =>
  projectFiles()
    .inFolder('**/application/**')
    .shouldNot()
    .dependOnFiles()
 ...
 */
export const uiShouldNotDependOnInfrastructure = () =>
  projectFiles()
    .inFolder('**/ui/**')
    .shouldNot()
    .dependOnFiles()
 ...
 */
export const servicesShouldNotDependOnDomain = () =>
  projectFiles()
    .inFolder('**/service-*/**')
    .shouldNot()
    .dependOnFiles()
...
export const servicesShouldNotDependOnApplication = () =>
  projectFiles()
    .inFolder('**/service-*/**')
    .shouldNot()
    .dependOnFiles()
